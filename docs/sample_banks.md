...
Stávající `sfz2ithacabank` tool (použitý pro Salamander) by měl fungovat pro všechny
...
3. Spustit sfz2ithacabank → C:\SoundBanks\ddsp\<nastroj>\
...
(rychlá extrakce). sfz2ithacabank toto zajišťuje automaticky.
